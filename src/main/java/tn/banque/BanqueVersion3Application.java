...
public class BanqueVersion3Application implements CommandLineRunner{
	@Autowired
	...
	public static void main(String[] args) {
		SpringApplication.run(BanqueVersion3Application.class, args);
	}
	...
	public void run(String... args) throws Exception {
		...
		Client c1 = clientRepository.save(new Client("Mohamed Ali","meddalijaziri@jaziri"));
		Client c2 = clientRepository.save(new Client("Ali","alijaziri@jaziri"));
		...
		if (test == true )
			System.out.print("Sucess de virer");
		else
			System.out.print("Failed");
		
		if (test == true )
			System.out.print("Sucess de retirer");
		else
			System.out.print("Failed");
